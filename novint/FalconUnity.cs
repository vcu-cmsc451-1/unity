...
public class FalconUnityCall {
    ...
    public static void sendDynamicShape (
        int body_num,
        float[] shape,
        int num_tris,
        float weight,
        ...
        Vector3 linearFactors,
        Vector3 angularFactors,
        float friction
    ) {
    ...
    public static void addSpringToShape (
        int body_num,
        int spring_num,
        float max_force,
        float dampingFactor,
        Vector3 goalPos,
        Quaternion goalOrient,
        Vector3 posConstraintLower,
        Vector3 posConstraintUpper,
        Vector3 orientConstraintLower,
        Vector3 orientConstraintUpper,
        int[] directionality
    ) {
    ...
    public static void setSpring (
        ...
        lerpSpring (
            ...
            posConstraintLower,
            posConstraintUpper,
            orientConstraintLower,
            orientConstraintUpper,
            directionality,
            0
        );
    }
...
public class FalconUnityCall{
    ...
    // attach a 6 dimensional damped spring to an existing concave shape
    [DllImport("falconunity")]
    public static extern bool addSpringToShape (
        int body_num,
        int spring_num,
        float max_force,
        float dampingFactor,
        float[] goalPos,
        float[] goalOrient,
        float[] posConstraintLower,
        float[] posConstraintUpper,
        float[] orientConstraintLower,
        float[] orientConstraintUpper,
        int[] directionality
    );
    ...
    // move the pose of the spring and set parameters
    [DllImport("falconunity")]
    public static extern bool setSpring (
        int spring_num,
        float max_force,
        float dampingFactor,
        float[] goalPos,
    ...
    // interpolate the pose and parameters of the given spring over the given time period.  interpolation is done at each physics tick
    [DllImport("falconunity")]
    public static extern bool lerpSpring (
        int spring_num,
        float max_force,
        float dampingFactor,
        float[] goalPos,
